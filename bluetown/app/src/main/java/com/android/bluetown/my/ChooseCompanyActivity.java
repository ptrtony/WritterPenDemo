...
import com.android.bluetown.adapter.ChooseCompanyAdapter;
...
/**
 * @author hedi
 * @data: 2016年5月4日 下午1:47:40
 * @Description: 选择公司
 */
public class ChooseCompanyActivity extends TitleBarActivity implements
	...
	public void onClick(View v) {
		...
		case R.id.rightTextLayout:
			if (TextUtils.isEmpty(searchView.getText().toString())) {
				TipDialog.showDialog(ChooseCompanyActivity.this,
	...
	private void getCompanyShow(String search) {
		...
		params.put("gardenId",getIntent().getStringExtra("gardenId"));
		// 企业查询的时候使用
	...
	protected void dealResult(CompanyShowResult result) {
		...
		if (adapter == null) {
			adapter = new ChooseCompanyAdapter(this, list, this);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		Intent resultIntent = ChooseCompanyActivity.this.getIntent();
 		resultIntent.putExtra("company",companyshowitembean.getCompanyName());
 		resultIntent.putExtra("companyId", companyshowitembean.getBid());
 		ChooseCompanyActivity.this.setResult(Activity.RESULT_OK, resultIntent);
