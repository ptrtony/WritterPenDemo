...
import com.android.bluetown.utils.Util.DensityUtil;
 ...
 */
public class DateSelectWheelView extends View {
	/** Scrolling duration */
	 ...
	 * Constructor
	 */
	public DateSelectWheelView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public DateSelectWheelView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * Constructor
	 */
	public DateSelectWheelView(Context context) {
		super(context);
		initData(context);
	}
