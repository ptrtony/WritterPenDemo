...
import com.android.bluetown.utils.ImageLoaderUtil;
...
public class NineGridCircleLayout extends NineGridLayout {

    protected static final int MAX_W_H_RATIO = 3;

    public NineGridCircleLayout(Context context) {
        super(context);
    }

    public NineGridCircleLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//        ImageLoaderUtil.getImageLoader(mContext).displayImage(url, imageView, ImageLoaderUtil.getPhotoImageOption());
    ...
    @Override
    protected void onClickImage(int i, String url, List<String> urlList,ImageView view) {
        if (onClickItemListener!=null){
            onClickItemListener.onClickItem(i,url,urlList,view);
        }
    }
