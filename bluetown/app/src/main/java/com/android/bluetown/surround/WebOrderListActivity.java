...
/**
 * Created by Dafen on 2018/8/21.
 */

public class WebOrderListActivity extends BaseWebActivity{
    @Override
    ...
    protected void initView() {
        ...
        webInterface = new WebTranslateInterface() {
            ...
            public void mainToOtherTranslate(String url) {
                Intent intent = new Intent(WebOrderListActivity.this,SmartRestaurantDetailsActivity.class);
