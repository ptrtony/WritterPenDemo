package com.android.bluetown.monitor.data;
...
public final class Config {
     ...
     */
    public static final String DEF_SERVER       = "http://61.153.145.166:80";

    private Config() {
        sp = BlueTownApp.getInstance().getSharedPreferences(CONFIG_FILE_NAME, Context.MODE_PRIVATE);
    }
