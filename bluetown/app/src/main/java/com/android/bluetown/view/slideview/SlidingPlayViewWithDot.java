 ...
 */
package com.android.bluetown.view.slideview;
...
public class SlidingPlayViewWithDot extends LinearLayout {
	 ...
	 */
	public SlidingPlayViewWithDot(Context context) {
		super(context);
		initView(context);
	}

	/**
	 * 从xml初始化的SlidingPlayView.
	 *
	 * @param context the context
	 * @param attrs the attrs
	 */
	public SlidingPlayViewWithDot(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
...
//		hideImage = AbFileUtil.getBitmapFromSrc("image/play_hide.png");
		displayImage=BitmapFactory.decodeResource(getResources(), R.drawable.slide_display_dian);
		hideImage=BitmapFactory.decodeResource(getResources(), R.drawable.slide_hide_dian);
